...
{
	private static final long serialVersionUID = 7769355659918308228L;
    ...
    public ClassExplorerDialog(Frame owner, ClassInformation classInformation)
    {
        ...
        classNode.add(new DefaultMutableTreeNode("<html><font color='blue'>Modifiers:</font>" + classInformation.getModifiers() + "</html>"));
