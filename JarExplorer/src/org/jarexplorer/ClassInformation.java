...
/**
 * Contains the information about a class in a jar. Allows for two ways of creation of objects of this type: lightweith and heavyweight.
 * The lighweight is created with a constructor, and does not contain any more information that passed to a
...
{
    private ArrayList<?> constructors = new ArrayList<Object>();
    private String[] fields = new String[]{};
    private String modifiers = "";
    private String superclass = "";
    private String[] interfaces = new String[]{};
    private ArrayList<?> methods = new ArrayList<Object>();
    private static ICallable callable;
     ...
     * operation is expensive (as expected)
     *  
     * @param jarName - name of a jar file (fully qualified)
     * @param classPath - name of class (really a resource, including a ".class")
     */
    ...
    public static ClassInformation createFully(String jarName, String className) throws IOException
    {
        ...
        if (className.endsWith(".class"))
        {
            ...
            classInfo.setClassName(classFile.getClassName());
    ...
    public static ICallable getCallable(String classPath) throws ClassNotFoundException, IllegalAccessException, InstantiationException {

        return null;
    }

    public void setCallable(ICallable callable) {
